...
const Modal = ({show = false}) => {
    return <>
        <div className={classNames("fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full bg-shadow", {hidden: !show})}>
            <div className="absolute translate-y-[-50%] translate-x-[-50%] top-[50%] left-[50%] w-[30%] h-[auto]">
